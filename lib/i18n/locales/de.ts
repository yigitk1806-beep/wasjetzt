...
export const de = {
  ...
  build: {
    ...
    peopleValue: (n: number) => `${n} ${n === 1 ? 'Person' : 'Personen'}`,
    peopleMore: '10+',
    peopleCustom: 'Anzahl eingeben',
    budgetTotal: 'gesamt',
    budgetHint: (n: number) => `Für ${n} ${n === 1 ? 'Person' : 'Personen'} zusammen`,
    budgetCustom: 'Anderer Betrag',
    food: 'Essen?',
    foodYes: 'Ja',
    foodNo: 'Nein',
  ...
  start: {
    title: 'Wo startet ihr?',
    device: 'Aktueller Standort',
    deviceHint: 'Per GPS',
    home: 'Zuhause',
    homeSet: 'Zuhause festlegen',
    homeHint: 'Gespeicherte Adresse',
    address: 'Adresse oder Ort suchen',
    addressPlaceholder: 'z. B. Müllerstraße 120 Berlin',
    map: 'Auf der Karte wählen',
    mapHint: 'Karte verschieben – der Punkt in der Mitte zählt.',
    mapConfirm: 'Hier starten',
    mapPicked: 'Auf der Karte gewählt',
    noResults: 'Dazu finde ich keine Adresse.',
    saveHome: 'Als Zuhause speichern',
    saved: 'Als Zuhause gespeichert',
